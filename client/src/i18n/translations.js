...
export const translations = {
  en: {
    ...
    "aset.addresses": "Addresses",
    "aset.addressesHint": "Up to 3 addresses shown in the footer. Each opens its Google Maps link in a new tab.",
    "aset.addressNameEn": "Address name (English)",
    "aset.addressNameTe": "Address name (Telugu)",
    "aset.mapLink": "Google Maps link",
    ...
    "queue.reject": "Reject",
    "queue.editName": "Farmer name",
    "queue.editYield": "Yield",
    "queue.editNotes": "Notes",
    "queue.english": "English",
    "queue.telugu": "Telugu",
  ...
  te: {
    ...
    "aset.addresses": "చిరునామాలు",
    "aset.addressesHint": "ఫుటర్‌లో చూపే గరిష్ఠంగా 3 చిరునామాలు. ప్రతి ఒక్కటి దాని గూగుల్ మ్యాప్స్ లింక్‌ను కొత్త ట్యాబ్‌లో తెరుస్తుంది.",
    "aset.addressNameEn": "చిరునామా పేరు (ఇంగ్లీష్)",
    "aset.addressNameTe": "చిరునామా పేరు (తెలుగు)",
    "aset.mapLink": "గూగుల్ మ్యాప్స్ లింక్",
    ...
    "queue.editName": "రైతు పేరు",
    "queue.editYield": "దిగుబడి",
    "queue.editNotes": "గమనికలు",
    "queue.english": "ఇంగ్లీష్",
    "queue.telugu": "తెలుగు",
